...
organizations:
  ...
  - name: CASIS
    url: https://www.casis.fr/fr/casis-cardiac-simulation-imaging-software/

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:romain.lemore@inria.fr'
    label: E-mail Me
  - icon: brands/cv
    link: uploads/EnVersion_CV_Lemore_Romain.pdf
#   - icon: brands/x
...
- Mail : romain(dot)lemore(at)inria(dot)fr
